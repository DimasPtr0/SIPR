                ...
                <div class="col-10 mx-auto shadow">
                    ...
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="username" <?php if (isset($_GET['username'])) {
                                                                                        echo "value='" . $_GET['username'] . "'";
                                                                                    } ?> required>
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input type="Password" class="form-control" name="Password" <?php if ($_SESSION['pass'] != $Password) {
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select" name="level" required>
                                ...
                                <option value="admin" <?php if ($_GET['level'] == 'admin') {
                                                            echo "selected";
                                                        } ?>>Admin</option>
                        ...
                        <form method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sex" required>
                                    <option value="Pria" <?php if ($edit['JK'] == "Pria") {
                                                                echo "selected";
                                                            } ?>>Pria</option>
                                    <option value="Wanita" <?php if ($edit['JK'] == "Wanita") {
                                                                echo "selected";
                                                            } ?>>Wanita</option>
                                </select>
                            </div>
            ...
            <div class="container">
                <div class="col-12 mx-auto">
                    <h3 class="text-center">
                        ...
                        <i class="fa fa-user"></i> Data Warga Rusunawa UBHI<span class="float-right no-print"><a href="admin.php?page=warga&act=tambah" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Data Warga</a></span>
                    </h3>
        ...
        ?>
            <div class="container">
                <div class="col-12 mx-auto">
                    <h3 class="text-center">
                        <span class="float-left"><button class="btn btn-info" onclick="javascript:window.print()"><i class="fa fa-print"></i> Print</button></span>
                        <i class="fa fa-building"></i> Data Unit Rusunawa UBHI <span class="float-right no-print"><a href="admin.php?page=unit&act=tambah" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Unit</a></span>
                    </h3>
                </div>
                <br>
                <div class="row">
...
elseif ($_GET["page"] == "hunian") {
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="KK" id="KK" required>
                                    ...
                                    <?php while ($option = mysqli_fetch_array($warga)) { ?>
                                        <option value="<?= $option['Nomor_KK'] ?>" <?php if ($huni['id_warga'] == $option['Nomor_KK']) {
                                                                                        echo $selected;
 ...
 --> <!-- <input type="date" class="form-control" name="tgl" <?php //if (isset($huni['tgl_masuk'])){ echo "value='".$huni['tgl_masuk']."'";}
                                                                ?> required> -->
                            <!-- </div> -->
                            <div class="form-group">
        ...
        ?>
            <div class="container">
                <div class="col-12 mx-auto">
                    <h3><i class="fa fa-home"></i> Data Penempatan Kamar</h3>
                </div>
                <br>
                <div class="row">
                    <div class="col-12 mx-auto">
    ...
    <style>
        body {
            background-image: url('img/rusun.jpg');
